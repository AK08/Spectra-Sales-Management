...
import SaleModal from './SaleModal'; // Assuming you have a SaleModal component

const SaleSingleCard = ({ sale }) => {
  ...
  return (
    <div className='border-2 border-gray-500 rounded-lg px-4 py-2 m-4 relative hover:shadow-xl'>
      ...
      {showModal && (
        <SaleModal sale={sale} onClose={() => setShowModal(false)} />
      )}
    </div>
  );
};

export default SaleSingleCard;
