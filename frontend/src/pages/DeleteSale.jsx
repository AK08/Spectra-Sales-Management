...
const DeleteSale = () => {
  ...
  const handleDeleteSale = () => {
    setLoading(true);
    axios
      .delete(`http://localhost:5555/sales/${id}`) // Update the API endpoint to match your backend's sales routes
      .then(() => {
        setLoading(false);
  ...
  return (
    <div className='p-4'>
      ...
      <div className='flex flex-col items-center border-2 border-sky-400 rounded-xl w-[600px] p-8 mx-auto'>
        <h3 className='text-2xl'>Are you sure you want to delete this sale?</h3>
